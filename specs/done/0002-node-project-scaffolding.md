...
`@jonathanleonel/kb-rag` is a lightweight RAG package extracted from DataClara — an omnichannel e-commerce management SaaS. It will be published to npm as a reusable package.
